...
use proxy_ping_pong_egld::{ContractState, UserStatus};
...
impl PingPongEgldInteract {
    pub async fn init(config: Config) -> Self {
        ...
        interactor.set_current_dir_from_workspace("contracts/ping-pong-egld/interactor");
