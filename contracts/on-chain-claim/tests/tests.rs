use multiversx_sc::types::{TokenIdentifier, ManagedAddress};
use on_chain_claim::*;
...
fn world() -> ScenarioWorld {
    ...
    blockchain.register_contract("file:output/on-chain-claim.wasm", on_chain_claim::ContractBuilder);
    blockchain
}
...
fn check_token_identifier() {
    ...
    world
        .set_state_step(
            SetStateStep::new()
                ...
                .put_account(
                    ...
                    Account::new()
                        .nonce(1)
                        .esdt_nft_balance(TOKEN_IDENTIFIER_EXPR, TOKEN_NONCE, "1", Option::Some(()))
                )
                .put_account(
                    SC_ADDR,
                    Account::new()
        ...
        .whitebox_call(&on_chain_claim_whitebox, 
            ScCallStep::new().from(SC_ADDR), 
            |sc| {
                sc.repair_streak_token_identifier().set(TokenIdentifier::from(TOKEN_IDENTIFIER));
            }
        );
}
        ...
        .set_state_step(
            SetStateStep::new()
                ...
                .put_account(
                    ...
                    Account::new()
                        .nonce(1)
                        .esdt_nft_balance(TOKEN_IDENTIFIER_EXPR, TOKEN_NONCE, "100", Option::Some(()))
                        .esdt_nft_balance(OTHER_TOKEN_IDENTIFIER_EXPR, TOKEN_NONCE, "1", Option::Some(()))
                )
                .put_account(
                    SC_ADDR,
                    Account::new()
