...
use multiversx_sc_scenario::{
    managed_biguint, managed_buffer, managed_token_id, rust_biguint,
...
where
    MysteryBoxObjBuilder: 'static + Copy + Fn() -> mystery_box_v2::ContractObj<DebugApi>,
{
    pub b_mock: BlockchainStateWrapper,
    pub owner_address: Address,
    pub mystery_box_wrapper:
        ContractObjWrapper<mystery_box_v2::ContractObj<DebugApi>, MysteryBoxObjBuilder>,
}
    ...
    MysteryBoxObjBuilder: 'static + Copy + Fn() -> mystery_box_v2::ContractObj<DebugApi>,
{
    ...
    pub fn internal_setup_mystery_box(
        ...
        mb_wrapper: &ContractObjWrapper<
            mystery_box_v2::ContractObj<DebugApi>,
            MysteryBoxObjBuilder,
        >,
