...
fn test_mystery_box_setup() {
    let _ = MysteryBoxSetup::new(mystery_box_v2::contract_obj);
}

#[test]
fn test_mb_token_nonce_stacking() {
    let mut mb_setup = MysteryBoxSetup::new(mystery_box_v2::contract_obj);
...
fn test_open_multiple_mystery_box() {
    ...
    mb_setup.b_mock.set_block_epoch(3);
    mb_setup.b_mock.set_block_random_seed(&[2u8; 48]);
    mb_setup.open_mystery_box(mb_token_nonce);

    // Change the block random seed
    mb_setup.b_mock.set_block_random_seed(&[3u8; 48]);
    mb_setup.open_mystery_box(mb_token_nonce);
    ...
    mb_setup.b_mock.set_block_random_seed(&[4u8; 48]);
    mb_setup.open_mystery_box(mb_token_nonce);
    mb_setup.open_mystery_box(mb_token_nonce);
    ...
    mb_setup.b_mock.set_block_random_seed(&[6u8; 48]);
    mb_setup.open_mystery_box(mb_token_nonce);
    mb_setup.open_mystery_box(mb_token_nonce);
    ...
    mb_setup.b_mock.set_block_random_seed(&[7u8; 48]);
    mb_setup.open_mystery_box(mb_token_nonce);
}
